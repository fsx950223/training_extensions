...
def train(config, init_checkpoint):
  ...
  with graph.as_default():
    ...
    prob = inference(config.rnn_cells_num, input_data, config.num_classes, config.train.apply_stn_aug)
    ...
    opt_loss = slim.optimize_loss(loss, global_step, learning_rate, config.train.opt_type,
